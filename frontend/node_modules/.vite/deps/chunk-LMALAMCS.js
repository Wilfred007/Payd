...
function verify2(options) {
  ...
  if (fromBytes(toBytes(challenge_extracted)) !== challenge2)
    return false;
...
function ecdh(Point2, ecdhOpts = {}) {
  ...
  return Object.freeze({ getPublicKey: getPublicKey2, getSharedSecret: getSharedSecret2, keygen, Point: Point2, utils: utils2, lengths });
}
function ecdsa(Point2, hash, ecdsaOpts = {}) {
  ...
  const { keygen, getPublicKey: getPublicKey2, getSharedSecret: getSharedSecret2, utils: utils2, lengths } = ecdh(Point2, ecdsaOpts);
...
*/
//# sourceMappingURL=chunk-LMALAMCS.js.map
