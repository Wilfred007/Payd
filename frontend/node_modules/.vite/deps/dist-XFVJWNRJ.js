...
var require_utils = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/utils.js"(exports) {
    ...
    function wrapConstructorWithOpts(hashCons) {
      const hashC = (msg, opts) => hashCons(opts).update(toBytes12(msg)).digest();
      const tmp = hashCons({});
      hashC.outputLen = tmp.outputLen;
      hashC.blockLen = tmp.blockLen;
...
function ecdsa(Point, hash8, ecdsaOpts = {}) {
  ...
  class Signature {
    ...
    static fromBytes(bytes2, format9 = defaultSigOpts_format) {
      validateSigLength(bytes2, format9);
      let recid;
      if (format9 === "der") {
...
function fromHex7(hex, group) {
  return fromBytes7(toBytes3(hex), group);
}
...
function verify2(options) {
  ...
  return secp256k1.verify(signature, from3(payload), toBytes4(publicKey), ...hash8 ? [{ prehash: true, lowS: true }] : []);
}
...
@noble/hashes/esm/utils.js:
  (*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=dist-XFVJWNRJ.js.map
