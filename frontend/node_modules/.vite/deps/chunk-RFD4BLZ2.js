...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-O5QZAEFA.js");
  const signature_ = (() => {
...
async function fillTransaction(client, parameters) {
  ...
  try {
    ...
    const format6 = ((_d = (_c = chain == null ? void 0 : chain.formatters) == null ? void 0 : _c.transaction) == null ? void 0 : _d.format) || formatTransaction;
    const transaction = format6(response.tx);
...
async function prepareTransactionRequest(client, args) {
  var _a, _b, _c;
  let request = args;
  const { account: account_ = client.account, chain = client.chain, nonceManager: nonceManager2, parameters = defaultParameters } = request;
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-RFD4BLZ2.js.map
